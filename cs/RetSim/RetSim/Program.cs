...
class Program
{
    ...
    static void RunOnce()
    {
        FightSimulation fight = new(new Player(Name, Race, Faction, Equipment, Talents, null), new Enemy(Boss), new EliteTactic(0, true, true), Buffs, Buffs, Debuffs, Consumables, MinDuration, MaxDuration, Cooldowns, Heroisms);
